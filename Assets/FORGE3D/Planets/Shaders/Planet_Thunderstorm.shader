	...
	SubShader
	{
		...
		Pass
		{
						 ...
						 ) : SV_Target
			{
				...
				float4 transform4_g200 = mul(GetObjectToWorldMatrix(),float4( IN.ase_normal , 0.0 ));
				float4 normalizeResult6_g200 = normalize( transform4_g200 );
				float3 temp_output_1_0_g201 = normalizeResult6_g200.xyz;
				float3 normalizeResult7_g200 = normalize( _MainLightPosition.xyz );
				float dotResult4_g201 = dot( temp_output_1_0_g201 , normalizeResult7_g200 );
				float3 normalizeResult8_g200 = normalize( WorldViewDirection );
				float dotResult7_g201 = dot( temp_output_1_0_g201 , normalizeResult8_g200 );
				float2 appendResult10_g201 = (float2(( ( dotResult4_g201 / 2.0 ) + 0.5 ) , dotResult7_g201));
				float3 tanToWorld0 = float3( WorldTangent.x, WorldBiTangent.x, WorldNormal.x );
				float3 tanToWorld1 = float3( WorldTangent.y, WorldBiTangent.y, WorldNormal.y );
				float3 tanToWorld2 = float3( WorldTangent.z, WorldBiTangent.z, WorldNormal.z );
				float3 ase_tanViewDir =  tanToWorld0 * WorldViewDirection.x + tanToWorld1 * WorldViewDirection.y  + tanToWorld2 * WorldViewDirection.z;
				ase_tanViewDir = normalize(ase_tanViewDir);
				float3 tanNormal51_g180 = float3(0,0,1);
				float3 worldNormal51_g180 = float3(dot(tanToWorld0,tanNormal51_g180), dot(tanToWorld1,tanNormal51_g180), dot(tanToWorld2,tanNormal51_g180));
				float4 appendResult63_g180 = (float4(worldNormal51_g180 , 0.0));
				float4 temp_output_57_0_g180 = mul( GetWorldToObjectMatrix(), appendResult63_g180 );
				float4 temp_cast_2 = (5.0).xxxx;
				float4 temp_output_4_0_g180 = pow( abs( temp_output_57_0_g180 ) , temp_cast_2 );
				float4 break6_g180 = temp_output_4_0_g180;
				float4 projNormal10_g180 = ( temp_output_4_0_g180 / ( break6_g180.x + break6_g180.y + break6_g180.z ) );
				float4 appendResult62_g180 = (float4(WorldPosition , 1.0));
				float4 break26_g180 = mul( GetWorldToObjectMatrix(), appendResult62_g180 );
				float2 appendResult27_g180 = (float2(break26_g180.z , break26_g180.y));
				float4 nSign18_g180 = sign( temp_output_57_0_g180 );
				float4 break20_g180 = nSign18_g180;
				float2 appendResult21_g180 = (float2(break20_g180.x , 1.0));
				float temp_output_29_0_g180 = _NormalTiling;
				float temp_output_10_0_g178 = ( _TimeParameters.x * _NormalSpeed );
				float2 appendResult12_g178 = (float2(temp_output_10_0_g178 , temp_output_10_0_g178));
				float3 tanNormal51_g179 = float3(0,0,1);
				float3 worldNormal51_g179 = float3(dot(tanToWorld0,tanNormal51_g179), dot(tanToWorld1,tanNormal51_g179), dot(tanToWorld2,tanNormal51_g179));
				float4 appendResult63_g179 = (float4(worldNormal51_g179 , 0.0));
				float4 temp_output_57_0_g179 = mul( GetWorldToObjectMatrix(), appendResult63_g179 );
				float4 temp_cast_3 = (5.0).xxxx;
				float4 temp_output_4_0_g179 = pow( abs( temp_output_57_0_g179 ) , temp_cast_3 );
				float4 break6_g179 = temp_output_4_0_g179;
				float4 projNormal10_g179 = ( temp_output_4_0_g179 / ( break6_g179.x + break6_g179.y + break6_g179.z ) );
				float4 appendResult62_g179 = (float4(WorldPosition , 1.0));
				float4 break26_g179 = mul( GetWorldToObjectMatrix(), appendResult62_g179 );
				float2 appendResult27_g179 = (float2(break26_g179.z , break26_g179.y));
				float4 nSign18_g179 = sign( temp_output_57_0_g179 );
				float4 break20_g179 = nSign18_g179;
				float2 appendResult21_g179 = (float2(break20_g179.x , 1.0));
				float temp_output_29_0_g179 = _NormalUVTiling;
				float temp_output_2_0_g178 = ( _TimeParameters.x * _NormalUVSpeed );
				float2 appendResult5_g178 = (float2(temp_output_2_0_g178 , temp_output_2_0_g178));
				float2 temp_output_65_0_g179 = appendResult5_g178;
				float2 appendResult32_g179 = (float2(break26_g179.x , break26_g179.z));
				float2 appendResult22_g179 = (float2(break20_g179.y , 1.0));
				float2 appendResult34_g179 = (float2(break26_g179.x , break26_g179.y));
				float2 appendResult25_g179 = (float2(-break20_g179.z , 1.0));
				float4 break11_g178 = ( saturate( ( ( projNormal10_g179.x * tex2D( _NormalMap, ( ( appendResult27_g179 * appendResult21_g179 * temp_output_29_0_g179 ) + temp_output_65_0_g179 ) ) ) + ( projNormal10_g179.y * tex2D( _NormalMap, ( ( temp_output_29_0_g179 * appendResult32_g179 * appendResult22_g179 ) + temp_output_65_0_g179 ) ) ) + ( projNormal10_g179.z * tex2D( _NormalMap, ( temp_output_65_0_g179 + ( temp_output_29_0_g179 * appendResult34_g179 * appendResult25_g179 ) ) ) ) ) ) * _NormlalDistortionFactor );
				float2 appendResult13_g178 = (float2(break11_g178.r , break11_g178.g));
				float2 temp_output_65_0_g180 = ( appendResult12_g178 + appendResult13_g178 );
				float2 appendResult32_g180 = (float2(break26_g180.x , break26_g180.z));
				float2 appendResult22_g180 = (float2(break20_g180.y , 1.0));
				float2 appendResult34_g180 = (float2(break26_g180.x , break26_g180.y));
				float2 appendResult25_g180 = (float2(-break20_g180.z , 1.0));
				float3 unpack18_g178 = UnpackNormalScale( saturate( ( ( projNormal10_g180.x * tex2D( _NormalMap, ( ( appendResult27_g180 * appendResult21_g180 * temp_output_29_0_g180 ) + temp_output_65_0_g180 ) ) ) + ( projNormal10_g180.y * tex2D( _NormalMap, ( ( temp_output_29_0_g180 * appendResult32_g180 * appendResult22_g180 ) + temp_output_65_0_g180 ) ) ) + ( projNormal10_g180.z * tex2D( _NormalMap, ( temp_output_65_0_g180 + ( temp_output_29_0_g180 * appendResult34_g180 * appendResult25_g180 ) ) ) ) ) ), _NormalScale );
				unpack18_g178.z = lerp( 1, unpack18_g178.z, saturate(_NormalScale) );
				float3 normalUnpacked24 = unpack18_g178;
				float3 normalizeResult5_g199 = normalize( normalUnpacked24 );
				float dotResult14_g199 = dot( ase_tanViewDir , normalizeResult5_g199 );
				...
				float3 Albedo = ( saturate( ( saturate( ( saturate( ( tex2D( _ScatterMap, ( ( _ScatterCenterShift + appendResult10_g201 ) * _ScatterStretch ) ) * _ScatterColor * _MainLightColor ) ) * _ScatterBoost ) ) + _ScatterIndirect ) ) * ( ( ( saturate( pow( max( 0.0 , saturate( ( 1.0 - dotResult14_g199 ) ) ) , _FresnelPower ) ) * _FrenselMult ) * _FresnelColor ) + saturate( lerpResult5 ) ) ).rgb;
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN  ) : SV_TARGET
			{
				...
				float3 normalizeResult8_g200 = normalize( ase_worldViewDir );
				float dotResult7_g201 = dot( temp_output_1_0_g201 , normalizeResult8_g200 );
				float2 appendResult10_g201 = (float2(( ( dotResult4_g201 / 2.0 ) + 0.5 ) , dotResult7_g201));
...
/*ASEBEGIN
Version=18935
1920;0;1920;1179;290.3831;486.3215;1.367078;True;False
...
Node;AmplifyShaderEditor.FunctionNode;31;-125.4292,-34.81888;Inherit;False;Fresnel;30;;199;f8c497a0c2d6d334f8e7138f24a77d5f;0;1;22;FLOAT3;0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.FunctionNode;36;1173.145,-95.66732;Inherit;False;ScatterColor;23;;200;5984f944e2b849e44aad6ac4d7027dc1;0;0;1;COLOR;0
...
Node;AmplifyShaderEditor.FunctionNode;79;-1856.686,690.6788;Inherit;False;TriplanarNormalUVDist;0;;178;1a5fcd4739bcd5240a12b19949e4bb06;0;0;1;FLOAT3;0
...
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;88;1632.305,40.10595;Float;False;False;-1;2;UnityEditor.ShaderGraphLitGUI;0;1;New Amplify Shader;94348b07e5e8bab40bd6c8a1e3df54cd;True;SceneSelectionPass;0;8;SceneSelectionPass;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;-1;False;True;0;False;-1;False;False;False;False;False;False;False;False;False;True;False;255;False;-1;255;False;-1;255;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;False;True;1;False;-1;True;3;False;-1;True;True;0;False;-1;0;False;-1;True;3;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;2;True;17;d3d9;d3d11;glcore;gles;gles3;metal;vulkan;xbox360;xboxone;xboxseries;ps4;playstation;psp2;n3ds;wiiu;switch;nomrt;0;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;2;False;-1;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;1;LightMode=SceneSelectionPass;False;True;4;d3d11;glcore;gles;gles3;0;Hidden/InternalErrorShader;0;0;Standard;0;False;0
...
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;89;1632.305,40.10595;Float;False;False;-1;2;UnityEditor.ShaderGraphLitGUI;0;1;New Amplify Shader;94348b07e5e8bab40bd6c8a1e3df54cd;True;ScenePickingPass;0;9;ScenePickingPass;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;-1;False;True;0;False;-1;False;False;False;False;False;False;False;False;False;True;False;255;False;-1;255;False;-1;255;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;False;True;1;False;-1;True;3;False;-1;True;True;0;False;-1;0;False;-1;True;3;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;2;True;17;d3d9;d3d11;glcore;gles;gles3;metal;vulkan;xbox360;xboxone;xboxseries;ps4;playstation;psp2;n3ds;wiiu;switch;nomrt;0;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;1;LightMode=Picking;False;True;4;d3d11;glcore;gles;gles3;0;Hidden/InternalErrorShader;0;0;Standard;0;False;0
...
ASEEND*/
//CHKSM=53505D9BD327BB06F602BA59ECF5894491546843