...
Shader "FORGE3D/Planets HD/Sun Corona"
{
	...
	SubShader
	{
		...
		Pass
		{
			...
			float2 _rotator14_g33( float speed, float2 uv )
			{
				uv -=0.5;
				float s = sin ( speed );
				float c = cos ( speed );
			...
			float2 _rotator14_g38( float speed, float2 uv )
			{
				uv -=0.5;
				float s = sin ( speed );
				float c = cos ( speed );
			...
			half4 frag ( VertexOutput IN  ) : SV_Target
			{
				...
				float4 ShadowCoords = float4( 0, 0, 0, 0 );
					...
					#endif
				#endif
				float speed14_g33 = 4.0;
				float2 texCoord76 = IN.ase_texcoord3.xy * float2( 1,1 ) + float2( 0,0 );
				float2 uv14_g33 = ( texCoord76 * 2.0 );
				float2 local_rotator14_g33 = _rotator14_g33( speed14_g33 , uv14_g33 );
				float2 temp_cast_0 = (0.5).xx;
				float2 temp_cast_1 = (2.0).xx;
				float2 break10_g32 = pow( ( texCoord76 - temp_cast_0 ) , temp_cast_1 );
				float cMaskC96 = saturate( ( 1.0 - pow( ( 3.75 * sqrt( ( ( 0.65 * break10_g32.x ) + ( 0.65 * break10_g32.y ) ) ) ) , 3.0 ) ) );
				float cNoiseE109 = ( pow( max( 0.0 , tex2D( _CoronaMap, local_rotator14_g33 ).r ) , 1.25 ) * 2.0 * cMaskC96 );
				...
				float speed14_g38 = ( ( _TimeParameters.x * 0.05 ) * 0.2 );
				float2 texCoord39 = IN.ase_texcoord3.xy * float2( 1,1 ) + float2( 0,0 );
				float2 uv14_g38 = ( texCoord39 * _CoronaFluidTile * 4.0 );
				float2 local_rotator14_g38 = _rotator14_g38( speed14_g38 , uv14_g38 );
				float cNoiseC48 = ( tex2D( _CoronaMap, local_rotator14_g38 ).r * _CoronaFluidInfluence );
				...
				float2 break10_g40 = pow( ( texCoord76 - temp_cast_8 ) , temp_cast_9 );
				float cMaskA82 = ( ( 1.0 - saturate( ( 1.0 - pow( ( 4.0 * sqrt( ( ( 1.0 * break10_g40.x ) + ( 1.0 * break10_g40.y ) ) ) ) , 3.0 ) ) ) ) * 3.5 );
				...
				float3 normalizeResult28_g36 = normalize( ( _WorldSpaceCameraPos - WorldPosition ) );
				float3 normalizeResult27_g36 = normalize( mul( float4( IN.ase_normal , 0.0 ), GetWorldToObjectMatrix() ).xyz );
				float dotResult9_g36 = dot( normalizeResult28_g36 , normalizeResult27_g36 );
				
				float3 BakedAlbedo = 0;
				float3 BakedEmission = 0;
				float3 Color = ( _CoronaColor * ( ( cNoiseE109 * sStorm70 ) + coronaAddCMaskB91 ) * 5.0 * cMaskB85 * saturate( distanceDepth120 ) * saturate( ( pow( abs( dotResult9_g36 ) , _EdgeFadeFalloff ) * _EdgeFadeBoost ) ) ).rgb;
				float Alpha = 1;
...
/*ASEBEGIN
Version=18935
1920;0;1920;1179;-1632.396;253.3506;1.3;True;False
...
Node;AmplifyShaderEditor.FunctionNode;110;382.0782,1282.758;Inherit;False;CoronaRotator;-1;;38;06e52d2d68369fb4f91c128e0a027a2b;0;2;3;FLOAT2;0,0;False;4;FLOAT;0;False;1;FLOAT2;0
...
Node;AmplifyShaderEditor.FunctionNode;94;1911.153,86.53137;Inherit;False;CoronaMask;-1;;40;cc04430f019e320459a73a9737a93acc;0;5;1;FLOAT2;0,0;False;3;FLOAT;1;False;2;FLOAT;1;False;4;FLOAT;4;False;5;FLOAT;3;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;111;1454.4,297.8069;Inherit;False;CoronaRotator;-1;;33;06e52d2d68369fb4f91c128e0a027a2b;0;2;3;FLOAT2;0,0;False;4;FLOAT;0;False;1;FLOAT2;0
...
Node;AmplifyShaderEditor.FunctionNode;95;1913.93,289.7608;Inherit;False;CoronaMask;-1;;32;cc04430f019e320459a73a9737a93acc;0;5;1;FLOAT2;0,0;False;3;FLOAT;0.65;False;2;FLOAT;0.65;False;4;FLOAT;3.75;False;5;FLOAT;3;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;137;3020.189,1078.31;Inherit;False;EdgeFade;0;;36;2dc743b47f4214b4e91929be3ab03f38;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;139;3639.866,645.6648;Float;False;True;-1;2;UnityEditor.ShaderGraphUnlitGUI;0;3;FORGE3D/Planets HD/Sun Corona;2992e84f91cbeb14eab234972e07ea9d;True;Forward;0;1;Forward;8;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;-1;False;True;2;False;-1;False;False;False;False;False;False;False;False;False;True;False;255;False;-1;255;False;-1;255;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;False;False;False;False;True;3;RenderPipeline=UniversalPipeline;RenderType=Transparent=RenderType;Queue=Transparent=Queue=0;True;2;True;17;d3d9;d3d11;glcore;gles;gles3;metal;vulkan;xbox360;xboxone;xboxseries;ps4;playstation;psp2;n3ds;wiiu;switch;nomrt;0;False;True;1;1;False;-1;1;False;-1;1;1;False;-1;10;False;-1;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;True;True;True;True;0;False;-1;False;False;False;False;False;False;False;True;False;255;False;-1;255;False;-1;255;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;False;True;2;False;-1;True;3;False;-1;True;True;0;False;-1;0;False;-1;True;1;LightMode=UniversalForwardOnly;False;False;0;Hidden/InternalErrorShader;0;0;Standard;22;Surface;1;0;  Blend;2;0;Two Sided;0;0;Cast Shadows;0;0;  Use Shadow Threshold;0;0;Receive Shadows;0;0;GPU Instancing;1;0;LOD CrossFade;0;0;Built-in Fog;0;0;DOTS Instancing;0;0;Meta Pass;0;0;Extra Pre Pass;0;0;Tessellation;0;0;  Phong;0;0;  Strength;0.5,False,-1;0;  Type;0;0;  Tess;16,False,-1;0;  Min;10,False,-1;0;  Max;25,False,-1;0;  Edge Length;16,False,-1;0;  Max Displacement;25,False,-1;0;Vertex Position,InvertActionOnDeselection;1;0;0;10;False;True;False;True;False;True;True;True;True;True;False;;False;0
...
ASEEND*/
//CHKSM=024B7832C6CB4664C962C07124CBFB0C37F48E07