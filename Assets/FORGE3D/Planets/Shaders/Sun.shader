...
Shader "FORGE3D/Planets HD/Sun"
{
	Properties
	{
		...
		[ASEEnd]_VertexFalloff("Vertex Falloff", Float) = 3
	...
	SubShader
	{
		...
		Pass
		{
			...
			half4 frag ( VertexOutput IN  ) : SV_Target
			{
				...
				float3 tanNormal51_g79 = float3(0,0,1);
				float3 worldNormal51_g79 = float3(dot(tanToWorld0,tanNormal51_g79), dot(tanToWorld1,tanNormal51_g79), dot(tanToWorld2,tanNormal51_g79));
				float4 appendResult63_g79 = (float4(worldNormal51_g79 , 0.0));
				float4 temp_output_57_0_g79 = mul( GetWorldToObjectMatrix(), appendResult63_g79 );
				float4 temp_cast_1 = (TriplanarFalloff).xxxx;
				float4 temp_output_4_0_g79 = pow( abs( temp_output_57_0_g79 ) , temp_cast_1 );
				float4 break6_g79 = temp_output_4_0_g79;
				float4 projNormal10_g79 = ( temp_output_4_0_g79 / ( break6_g79.x + break6_g79.y + break6_g79.z ) );
				float4 appendResult62_g79 = (float4(WorldPosition , 1.0));
				float4 break26_g79 = mul( GetWorldToObjectMatrix(), appendResult62_g79 );
				float2 appendResult27_g79 = (float2(break26_g79.z , break26_g79.y));
				float4 nSign18_g79 = sign( temp_output_57_0_g79 );
				float4 break20_g79 = nSign18_g79;
				float2 appendResult21_g79 = (float2(break20_g79.x , 1.0));
				float temp_output_29_0_g79 = _SunGTiling;
				float temp_output_10_0_g78 = ( _TimeParameters.x * _SurfaceSpeed );
				float2 appendResult12_g78 = (float2(temp_output_10_0_g78 , temp_output_10_0_g78));
				float3 tanNormal51_g80 = float3(0,0,1);
				float3 worldNormal51_g80 = float3(dot(tanToWorld0,tanNormal51_g80), dot(tanToWorld1,tanNormal51_g80), dot(tanToWorld2,tanNormal51_g80));
				float4 appendResult63_g80 = (float4(worldNormal51_g80 , 0.0));
				float4 temp_output_57_0_g80 = mul( GetWorldToObjectMatrix(), appendResult63_g80 );
				float4 temp_cast_2 = (TriplanarFalloff).xxxx;
				float4 temp_output_4_0_g80 = pow( abs( temp_output_57_0_g80 ) , temp_cast_2 );
				float4 break6_g80 = temp_output_4_0_g80;
				float4 projNormal10_g80 = ( temp_output_4_0_g80 / ( break6_g80.x + break6_g80.y + break6_g80.z ) );
				float4 appendResult62_g80 = (float4(WorldPosition , 1.0));
				float4 break26_g80 = mul( GetWorldToObjectMatrix(), appendResult62_g80 );
				float2 appendResult27_g80 = (float2(break26_g80.z , break26_g80.y));
				float4 nSign18_g80 = sign( temp_output_57_0_g80 );
				float4 break20_g80 = nSign18_g80;
				float2 appendResult21_g80 = (float2(break20_g80.x , 1.0));
				float temp_output_29_0_g80 = _DistortionUVTiling;
				float temp_output_2_0_g78 = ( _TimeParameters.x * _DistortionUVSpeed );
				float2 appendResult5_g78 = (float2(temp_output_2_0_g78 , temp_output_2_0_g78));
				float2 temp_output_65_0_g80 = appendResult5_g78;
				float2 appendResult32_g80 = (float2(break26_g80.x , break26_g80.z));
				float2 appendResult22_g80 = (float2(break20_g80.y , 1.0));
				float2 appendResult34_g80 = (float2(break26_g80.x , break26_g80.y));
				float2 appendResult25_g80 = (float2(-break20_g80.z , 1.0));
				float4 break11_g78 = ( saturate( ( ( projNormal10_g80.x * tex2D( _DistortionUVMap, ( ( appendResult27_g80 * appendResult21_g80 * temp_output_29_0_g80 ) + temp_output_65_0_g80 ) ) ) + ( projNormal10_g80.y * tex2D( _DistortionUVMap, ( ( temp_output_29_0_g80 * appendResult32_g80 * appendResult22_g80 ) + temp_output_65_0_g80 ) ) ) + ( projNormal10_g80.z * tex2D( _DistortionUVMap, ( temp_output_65_0_g80 + ( temp_output_29_0_g80 * appendResult34_g80 * appendResult25_g80 ) ) ) ) ) ) * _DistortionFactor );
				float2 appendResult13_g78 = (float2(break11_g78.r , break11_g78.g));
				float2 temp_output_15_0_g78 = ( appendResult12_g78 + appendResult13_g78 );
				float2 temp_output_65_0_g79 = temp_output_15_0_g78;
				float2 appendResult32_g79 = (float2(break26_g79.x , break26_g79.z));
				float2 appendResult22_g79 = (float2(break20_g79.y , 1.0));
				float2 appendResult34_g79 = (float2(break26_g79.x , break26_g79.y));
				float2 appendResult25_g79 = (float2(-break20_g79.z , 1.0));
				float temp_output_76_22 = saturate( ( ( projNormal10_g79.x * tex2D( _SurfraceMap, ( ( appendResult27_g79 * appendResult21_g79 * temp_output_29_0_g79 ) + temp_output_65_0_g79 ) ) ) + ( projNormal10_g79.y * tex2D( _SurfraceMap, ( ( temp_output_29_0_g79 * appendResult32_g79 * appendResult22_g79 ) + temp_output_65_0_g79 ) ) ) + ( projNormal10_g79.z * tex2D( _SurfraceMap, ( temp_output_65_0_g79 + ( temp_output_29_0_g79 * appendResult34_g79 * appendResult25_g79 ) ) ) ) ) ).g;
				...
				float3 tanNormal51_g81 = float3(0,0,1);
				float3 worldNormal51_g81 = float3(dot(tanToWorld0,tanNormal51_g81), dot(tanToWorld1,tanNormal51_g81), dot(tanToWorld2,tanNormal51_g81));
				float4 appendResult63_g81 = (float4(worldNormal51_g81 , 0.0));
				float4 temp_output_57_0_g81 = mul( GetWorldToObjectMatrix(), appendResult63_g81 );
				float4 temp_cast_3 = (TriplanarFalloff).xxxx;
				float4 temp_output_4_0_g81 = pow( abs( temp_output_57_0_g81 ) , temp_cast_3 );
				float4 break6_g81 = temp_output_4_0_g81;
				float4 projNormal10_g81 = ( temp_output_4_0_g81 / ( break6_g81.x + break6_g81.y + break6_g81.z ) );
				float4 appendResult62_g81 = (float4(WorldPosition , 1.0));
				float4 break26_g81 = mul( GetWorldToObjectMatrix(), appendResult62_g81 );
				float2 appendResult27_g81 = (float2(break26_g81.z , break26_g81.y));
				float4 nSign18_g81 = sign( temp_output_57_0_g81 );
				float4 break20_g81 = nSign18_g81;
				float2 appendResult21_g81 = (float2(break20_g81.x , 1.0));
				float temp_output_29_0_g81 = _SunRTiling;
				float2 temp_output_65_0_g81 = temp_output_15_0_g78;
				float2 appendResult32_g81 = (float2(break26_g81.x , break26_g81.z));
				float2 appendResult22_g81 = (float2(break20_g81.y , 1.0));
				float2 appendResult34_g81 = (float2(break26_g81.x , break26_g81.y));
				float2 appendResult25_g81 = (float2(-break20_g81.z , 1.0));
				float3 ase_worldViewDir = ( _WorldSpaceCameraPos.xyz - WorldPosition );
				ase_worldViewDir = normalize(ase_worldViewDir);
				float3 ase_tanViewDir =  tanToWorld0 * ase_worldViewDir.x + tanToWorld1 * ase_worldViewDir.y  + tanToWorld2 * ase_worldViewDir.z;
				ase_tanViewDir = normalize(ase_tanViewDir);
				float3 normalizeResult5_g77 = normalize( float4(0,0,1,0).xyz );
				float dotResult14_g77 = dot( ase_tanViewDir , normalizeResult5_g77 );
				
				float3 BakedAlbedo = 0;
				float3 BakedEmission = 0;
				float3 Color = max( temp_cast_0 , ( ( ( lerpResult12 * temp_output_76_22 ) + ( ( pow( max( 0.0 , saturate( ( ( projNormal10_g81.x * tex2D( _SurfraceMap, ( ( appendResult27_g81 * appendResult21_g81 * temp_output_29_0_g81 ) + temp_output_65_0_g81 ) ) ) + ( projNormal10_g81.y * tex2D( _SurfraceMap, ( ( temp_output_29_0_g81 * appendResult32_g81 * appendResult22_g81 ) + temp_output_65_0_g81 ) ) ) + ( projNormal10_g81.z * tex2D( _SurfraceMap, ( temp_output_65_0_g81 + ( temp_output_29_0_g81 * appendResult34_g81 * appendResult25_g81 ) ) ) ) ) ).r ) , _FlakesPower ) * _FlakesMult ) * _Hot * _Hot.a ) + ( ( saturate( pow( max( 0.0 , saturate( ( 1.0 - dotResult14_g77 ) ) ) , _FresnelPower ) ) * _FrenselMult ) * _FresnelColor ) ) * _Boost ) ).rgb;
				float Alpha = 1;
...
/*ASEBEGIN
Version=18935
1920;0;1920;1179;843.4734;1405.877;2.040653;True;False
...
Node;AmplifyShaderEditor.FunctionNode;76;-1335.171,-128.1096;Inherit;False;TriplanarSun;0;;78;42e513d8602709b41bcd284c568c637f;0;0;2;FLOAT;0;FLOAT;22
...
Node;AmplifyShaderEditor.FunctionNode;84;255.0919,52.3579;Inherit;False;Fresnel;17;;77;f8c497a0c2d6d334f8e7138f24a77d5f;0;1;22;FLOAT3;0,0,0;False;1;COLOR;0
...
ASEEND*/
//CHKSM=69210A49B1FBE2C91E30352A1A6192BA742B6AEB